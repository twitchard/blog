...
I should say, the ability to reify "plumbing" is not the be all and end all of monads -- the monad abstraction is very general and has other interpretations and uses -- but I hope these examples have given you a flavor of how monads are commonly used and why programmers get excited about them.
