...
The last example I'll discuss is the popular blog post ["Work is Work"](https://codahale.com/work-is-work/) by Coda Hale. 
...
Let's not be hypnotized by fancy equations, and check our experience and intuitions. Is this story actually plausible? Over the last decade or so, the company I work for[^3] grew from dozens to thousands of engineers. If tomorrow they decided to fire all the engineers except for me, this would eliminate contention costs and coherence costs. I wouldn't have to contend with anybody for the QA environment. I wouldn't need to communicate with anybody, either. Would I suddenly be able to ship my assigned feature as fast as I could have back in 2012?
...
[^1]: Disclaimer: I have a lot of opinions about how software organizations should be led, but I am not a manager, so add some grains of salt, to taste. I am a line engineer. I did have a small team of reports, once. The way I see it, though, is that these management types have all sorts of opinions about the right way for me to do my job. I'm entitled to my share of opinions about how they should do theirs. After all, we line engineers are the ones who feel the impact.
...
[^3]: Fun fact: Hale worked for the same company half a decade before me.
