...
class: prose
description: "Should an SDK wrap your API one-to-one, or carry logic of its own? Usually thin wins, but here is when a thick SDK earns its keep."
