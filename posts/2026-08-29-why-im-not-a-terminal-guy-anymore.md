...
I never really had a problem scrolling bash sessions in the terminal -- perhaps because the output of bash commands is a lot more visually heterogenous than paragraph after paragraph of AI prose? 
...
Another thing I get a lot of milage out of is Codex "deeplinks", e.g. if I click on a link to `codex://threads/017045c6-ef46-7374-8200-b1b97322d4c8` it will focus that particular session. This is useful when my agents are writing Slack messages to me, or when they are rendering custom `.html` for me to look at.
